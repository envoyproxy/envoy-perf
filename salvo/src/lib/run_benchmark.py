...
class Benchmark(object):
    ...
    def create_job_control_for_images(self, image_hashes):
        ...
        """
        if not all([CURRENT in image_hashes,
                    PREVIOUS in image_hashes]):
    ...
    def execute(self):
        ...
        log.info(f"{horizontal_bar} Running benchmark for current (baseline) Envoy version {horizontal_bar}")
